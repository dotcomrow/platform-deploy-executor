...
export const deployRequestSchema = z.object({
  ...
  openobserve_sourcemaps_enabled: z.boolean().or(z.string()).optional().default(true),
  openobserve_sourcemap_upload_url: z.string().optional().default(""),
  openobserve_sourcemap_upload_auth_scheme: z.string().optional().default(""),
  openobserve_sourcemap_upload_auth_token_lookup_from_vault: z.boolean().or(z.string()).optional().default(true),
  openobserve_sourcemap_upload_auth_token_vault_mount: z.string().optional().default(""),
  openobserve_sourcemap_upload_auth_token_vault_name: z.string().optional().default(""),
  openobserve_sourcemap_upload_auth_token_vault_field: z.string().optional().default(""),
  app_log_openobserve_organization_identifier: z.string().optional().default(""),
