...
export const openApiSpec = {
  ...
  paths: {
    ...
    "/internal/operations/{id}/steps/preview-deploy": { post: { operationId: "previewDeploy", security: [{ internalBearer: [] }], parameters: [{ $ref: "#/components/parameters/OperationIdPath" }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/DeployStepRequest" } } } }, responses: { "200": { description: "Preview deploy step completed", content: { "application/json": { schema: { $ref: "#/components/schemas/StepResponse" } } } }, "422": { description: "Invalid deployment request" }, "501": { description: "Configured provider is not implemented" } } } },
